...
export class AllProductsComponent implements OnInit {
  ...
  constructor(private productService: ProductService, public dialog: MatDialog, private activatedRoute: ActivatedRoute) {
  ...
  productSearch(){
    let exist = this.masterProduct.filter(product => product.title?.toLocaleLowerCase().includes(this.search?.toLocaleLowerCase() || ''));
      this.products = [...exist];
  }
